...
public class CountryFragment extends Fragment {
    ...
    private void LoadEurasia() {
        countryModels.add(new CountryModel("https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Flag_of_Qatar.svg/1200px-Flag_of_Qatar.svg.png", "Qatar"));
        ...
        countryModels.add(new CountryModel("https://www.advantour.com/img/kyrgyzstan/symbolics/kyrgyzstan-flag.jpg", "Kyrgyzstan"));
    }
}